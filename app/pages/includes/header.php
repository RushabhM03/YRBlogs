    ...
    <header class="p-3 border-bottom shadow">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">
                <img class="bi me-2" src="<?=ROOT?>/assets/images/mainlogo.jpg" alt="" width="60" height="52" style="object-fir: cover">
            </a>
            ...
            <li>
            <div class="nav-link px-2 link-dark dropdown text-end">
                <a href="#" class="d-block text-decoration-none dropdown-toggle <?=$url[0]== 'category'? ' link-primary': ' link-dark'?>" data-bs-toggle="dropdown" aria-expanded="false">
                    Category
                </a>
                    ...
                    <?php if(!empty($categories)) :?>
                        <?php foreach($categories as $cat) :?>
                            <li><a class="dropdown-item" href="<?=ROOT?>/category/<?=$cat['category']?>"><?=$cat['category']?></a></li>
                        <?php endforeach; ?>
                    <?php endif; ?>
            ...
            <div class="dropdown text-end">
                <a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?=get_image(user('image'))?>" style="object-fit: cover;" alt="mdo" width="32" height="32" class="rounded-circle">
                </a>
                    <ul class="dropdown-menu text-small">
                        <li><a class="dropdown-item" href="<?=ROOT?>/profile">Hi, <?=user('username')?></a></li>
